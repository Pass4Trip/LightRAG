...
# Désactivé pour réduire la taille de l'image Docker
...
def hf_embedding(texts: list[str], tokenizer=None, embed_model=None, **kwargs):
    """
    Version stub de hf_embedding qui retourne des embeddings vides
    pour éviter d'avoir à installer transformers et torch
    
    Args:
        texts (list[str]): Liste de textes à encoder
        tokenizer: Non utilisé dans cette version stub
        embed_model: Non utilisé dans cette version stub
    
    Returns:
        np.ndarray: Embeddings vides de dimension 384
    """
